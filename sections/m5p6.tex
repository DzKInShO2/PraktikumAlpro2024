...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item {
            Akses {\struct} melibatkan operasi membaca atau menulis data di dalam {\struct} yang telah dideklarasikan dan diinisialisasi. Untuk mengakses anggota dari {\struct}, digunakan operator titik (\inputscript{.}) untuk mengacu pada masing-masing elemen di dalam {\struct} tersebut. Misalnya, untuk mengakses nama dari {\struct} mahasiswa, digunakan sintaks \inputscript{mahasiswa.nama}.
        }
        \item {
