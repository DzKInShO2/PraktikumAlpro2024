...
\end{lstlisting}
    ...
    Hal terpenting ketika membuat fungsi \textit{recursive} ialah harus ada setidaknya satu cara untuk meninggalkan fungsi tersebut. Dalam kasus diatas kekika fungsi \inputscript{factorial} dipanggil dengan argumen 1 \parencite{grimes2017beginning}.
