...
\end{indentlevel0}
    ...
    \subsubsection{\Flowchart}
    \inputfigure[p]{res/m4i14.png}{0.26}{{\Flowchart} Permasalahan Matematika Diskrit dan Aljabar Linier}{fig:m4:i14}
    \newpage
    \subsubsection{\SourceCode}
\begin{indentlevel0}
    \vspace{-0.15ex}
...
\end{indentlevel0}
    \subsubsection{Hasil Program}
    \inputfigure[p]{res/m4i15.png}{0.65}{Hasil Program Permasalahan Matematika Diskrit dan Aljabar Linier Pilihan 1}{fig:m4:i15}
    \begin{indentlevel0}
    ...
    \inputfigure[p]{res/m4i16.png}{0.65}{Hasil Program Permasalahan Matematika Diskrit dan Aljabar Linier Pilihan 2}{fig:m4:i16}
    \begin{indentlevel0}
