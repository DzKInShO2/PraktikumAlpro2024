...
\begin{document}
    ...
    \inputfigure[p]{res/m4i12.png}{0.25}{{\Flowchart} Program Rental PS Rijal}{fig:m4:i12}
...
\end{indentlevel0}
    ...
    \subsubsection{\Flowchart}
    \inputfigure[p]{res/m4i14.png}{0.225}{{\Flowchart} Permasalahan Matematika Diskrit dan Aljabar Linier}{fig:m4:i14}
    \vspace{-0.5ex}
    \subsubsection{\SourceCode}
    \vspace{-0.5ex}
\begin{indentlevel0}
