...
\begin{lstlisting}
 ...
 using namespace std;
\end{lstlisting}
    \ilz{}{\Script} diatas digunakan untuk memberikan kemampuan untuk menggunakan fungsi-fungsi dan objek-objek yang tersedia dalah {\header} {\file} \inputscript{iostream}. Baris \inputscript{using namespace std;} menghilangkan kebutuhan untuk menulis \inputscript{std::}.
...
\begin{lstlisting}
 ...
 string wagon_types[] = {
   "EKO", "BISNIS", "RAJA" };
\end{lstlisting}
    \ilz{}{\Script} diatas merupakan kumpulan data-data dan struktur data yang akan digunakan untuk mengatur alur kerja program Kereta Api Pemrograman. Struktur dara \inputscript{struct Wagon} digunakan untuk merapikan dan penyimpan data penumpang.
...
\end{lstlisting}
    \ilz{}{\Script} diatas merupakan sebuah fungsi dengan kembalian berupa \inputscript{int} atau bilangan bulat. Fungsi tersebut akan menyaring masukan dari pengguna sesuai kedua parameter fungsi \inputscript{int l} dan \inputscript{int u}.
...
\begin{lstlisting}
 string tselector(string msg) {
   ...
   return t; }
\end{lstlisting}
    \ilz{}{\Script} diatas merupakan sebuah fungsi yang mengembalikan sebuah objek bertipe data \inputscript{string}. Fungsi tersebut akan mengecek apakah masukan masuk kedalam kategori \inputscript{EKO}, \inputscript{BISNIS}, dan \inputscript{RAJA}. Bila masukan diluar kategori maka masukan akan diminta lagi.
...
\end{lstlisting}
    \ilz{}{\Script} diatas merupakan sebuah fungsi yang mengembalikan sebuah nilai bilangan bulat atau \inputscript{int}. Fungsi tersebut akan mengubah kategori dari paragraf sebelumnya menjadi sebuah index sehingga memudahkan pemerosesan data.
...
\end{lstlisting}
    \ilz{}{\Script} diatas digunakan untuk meminta masukan jumlah gerbong penumpang melalui fungsi \inputscript{nselector}. Setelah itu gerbong akan diinisialisasikan dengan ukuran yang sudah dimansukan seperti yang dapat dilihat dari {\statement} \inputscript{Wagon wagons[wagon\_count]}.
...
\end{lstlisting}
    \ilz{}{\Script} diatas digunakan untuk menggambar gerbong penumpang sesuai dengan jumlah yang telah dimasukan sebelumnya. Sebelum gerbong-gerbong penumpang digambar pertama kali akan digambar gerbong mesin yakni gerbong \inputscript{A}. Gerbong penumpang akan diawali oleh gerbong \inputscript{B} kemudian jumlah penumpag gerbong dan diikuti oleh huruf-huruf lainnya.
...
\end{lstlisting}
    \ilz{}{\Script} diatas digunakan untuk menampilkan gerbang-gerbang beserta penumpang-penumpang di dalamnya. Di samping nama gerbong akan disediakan kelas gerbong. Pada bagian teratas akan ditampilkan jumlah penumpang kereta yang dipisahkan menurut kelas gerbong.
