...
{\Pointer} dapat didefinisikan sebagai suatu variabel yang menyimpat alamat memori. Jika kita mempunyai variabel dengan tipe data tertentu, maka untuk mendapatkan alamat dari variabel tersebut adalah dengan menggunakan operator \citecode{\&} \parencite{raharjo2015pemrograman}.
