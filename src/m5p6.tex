...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item {
            Akses {\struct} melibatkan operasi membaca atau menulis data di dalam {\struct} yang telah dideklarasikan dan diinisialisasi. Untuk mengakses anggota dari {\struct}, digunakan operator titik (.) untuk mengacu pada masing-masing elemen di dalam {\struct} tersebut.
        }
        \item {
