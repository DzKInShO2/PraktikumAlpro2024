...
\begin{document}
    ...
    \inputfigure{res/m5i1.png}{0.7}{Keluaran Bagian 1 Program PT. KAP Kereta Api Pemrograman}{fig:m5:i1}
    {\color{white}a\vspace*{-1.8ex}}
    \inputfigure{res/m5i2.png}{0.3}{Keluaran Bagian 2 Program PT. KAP Kereta Api Pemrograman}{fig:m5:i2}
    ...
    \inputfigure{res/m5i3.png}{0.5}{Keluaran Bagian 3 Program PT. KAP Kereta Api Pemrograman}{fig:m5:i3}
    ...
    \inputfigure{res/m5i4.png}{0.45}{Keluaran Bagian 4 Program PT. KAP Kereta Api Pemrograman}{fig:m5:i4}

    Holil dapat menambahkan penumpang baru dengan memasukkan nama, memasukkan kelas tiket, dan memilih gerbong yang tersedia.

    \inputfigure{res/m5i5.png}{0.55}{Keluaran Bagian 5 Program PT. KAP Kereta Api Pemrograman}{fig:m5:i5}

    Holil dapat menghapus penumpang dengan memasukkan nama, memasukkan kelas tiket, dan memilih menghapus penumpang yang mana.

    \inputfigure{res/m5i6.png}{0.48}{Keluaran Bagian 6 Program PT. KAP Kereta Api Pemrograman}{fig:m5:i6}
    ...
    \inputfigure{res/m5i7.png}{0.48}{Keluaran Bagian 7 Program PT. KAP Kereta Api Pemrograman}{fig:m5:i7}
