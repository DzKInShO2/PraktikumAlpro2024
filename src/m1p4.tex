...
\vspace{0.5ex}
\inputfigure[n]{res/m1f1.png}{0.215}{{\Flowchart} Program Menghitung Suhu Ruangan}{fig:m1:f1}
...
\begin{indentpar}
    ...
    Paragraf seterusnya menunjukan perubahan waktu dan dampaknya pada suhu awal. Seperti yang dapat dilihat pada paragraf ketiga semakin banyak waktu berlalu semakin menurun suhu ruangan. Di paragraf setelah itu ditunjukan suhu awal ruangan dan suhu saat ini setelah 45 menit berlalu dari awal jalannya program. Kemudian akan ditampilkan suhu setelah pendingin dimatikan selama 25 menit. Pada akhirnya akan ditampilkan perbandingan suhu-suhu tersebut dengan suhu awal.
\end{indentpar}
