...
\inputfigure[n]{res/m5i11.png}{0.20}{{\Flowchart} Program KAP}{fig:m5:i11}
\newpage
...
\inputfigure[n]{res/m5i12.png}{0.45}{Pertanyaan Jumlah Gerbong Program KAP}{fig:m5:i12}
...
\inputfigure[n]{res/m5i13.png}{0.45}{Halaman Awal Program KAP}{fig:m5:i13}
...
\inputfigure[n]{res/m5i14.png}{0.45}{Tambah Penumpang Program KAP}{fig:m5:i14}
...
\end{indentpar}
\blanktop
\inputfigure[n]{res/m5i15.png}{0.35}{Info Penumpang Program KAP}{fig:m5:i15}
...
\inputfigure[n]{res/m5i16.png}{0.35}{Hapus Penumpang Program KAP}{fig:m5:i16}
...
\inputfigure[n]{res/m5i17.png}{0.4}{Lepas Gerbong Program KAP}{fig:m5:i17}

\begin{indentpar}
    \hspace{\parindent}Berdasarkan \Cref{fig:m5:i17}, didapatkan sebuah gambar keluaran dari program Kereta Api Pemrograman. Gambar tersebut merupakan gambaran proses pelepasan sebuah gerbong penumpang dari kereta.
\end{indentpar}
\blanktop
\inputfigure[n]{res/m5i18.png}{0.45}{Menu Awal Setelah Lepas Gerbong Program KAP}{fig:m5:i18}
...
\inputfigure[n]{res/m5i19.png}{0.45}{Info Gerbong Setelah Lepas Gerbong Program KAP}{fig:m5:i19}
