...
{\Script} di atas merupakan potongan dari fungsi \citecode{game\_create}. Fungsi \citecode{game\_create} itu sendiri digunakan untuk menginisialisasikan sebuah permainan seperti contohnya diatas \citecode{game->players[0] = { 1000, 150, 30, -1, 1, "Holil" };} yang mengisi data-data terkait pemain 1.
...
{\Script} di atas merupakan bagian dari fungsi \citecode{game\_create}. Potongan fungsi tersebut digunakan untuk mengisi data terkait sebuah \textit{monster} yang bernama Phoenix. \textit{Monster} tersebut memiliki kehidupan sebanyak 950, kekuatan serangan sebanyak 140 dan perhatanan sebanyak 10.
...
{\Script} di atas merupakan bagian dari fungsi \citecode{game\_create}. Potongan fungsi tersebut digunakan untuk mengisi data terkait sebuah \textit{monster} yang bernama Leviathan. \textit{Monster} tersebut memiliki kehidupan sebanyak 5000, kekuatan serangan sebanyak 350 dan perhatanan sebanyak 50.
