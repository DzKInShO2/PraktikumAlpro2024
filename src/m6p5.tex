...
{\Script} di atas merupakan fungsi tanpa nilai kembalian yang digunakan untuk menulusuri data-data yang tersimpan dalam \citecode{stack}. Penampilannya akan dipisah menjadi dua bagian yakni \textit{stack} dan \textit{register} yang akan berubah sesuai nilai yang terkandung pada variabel \citecode{stack}.
