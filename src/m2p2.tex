...
\textit{Switch case} merupakan bentuk lain dari \textit{nested if}, hal ini karena \textit{switch case} memiliki prinsip kerja yang sama, tetapi dengan format penulisan yang berbeda \parencite{hanief2020konsep}.
\end{indentpar}
\vspace{-1ex}
\begin{code}[n]
\begin{verbatim}
