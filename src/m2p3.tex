...
\begin{document}
    ...
    \inputfigure{res/m2i1.png}{0.4}{Keluaran Pertama Program Bagi THR}{fig:m2:i1}
    ...
    \inputfigure{res/m2i2.png}{0.45}{Keluaran Kedua Program Bagi THR}{fig:m2:i2}
    ...
    \inputfigure{res/m2i3.png}{0.1}{Keluaran Ketiga Program Bagi THR}{fig:m2:i3}
    ...
    \inputfigure{res/m2i4.png}{0.16}{Keluaran Pertama Program Motif Baju}{fig:m2:i4}
    ...
    \inputfigure{res/m2i5.png}{0.16}{Keluaran Kedua Program Motif Baju}{fig:m2:i5}
    ...
    \inputfigure{res/m2i6.png}{0.16}{Keluaran Ketiga Program Motif Baju}{fig:m2:i6}
    ...
    \inputfigure{res/m2i7.png}{0.3}{Keluaran Keempat Program Motif Baju}{fig:m2:i7}
    ...
    \inputfigure{res/m2i8.png}{0.3}{Keluaran Kelima Program Motif Baju}{fig:m2:i8}
    ...
    \inputfigure{res/m2i9.png}{1.0}{Gambar Bulan Yang Akan Dianimasikan Oleh Program Hilal}{fig:m2:i9}
\end{document}
