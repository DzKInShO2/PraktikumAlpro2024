...
\begin{document}
    ...
    \inputfigure{res/m2i1.png}{0.45}{Keluaran Pertama Program Bagi THR}{fig:m2:i1}
    ...
    \inputfigure{res/m2i2.png}{0.6}{Keluaran Kedua Program Bagi THR}{fig:m2:i2}
    ...
    \inputfigure{res/m2i3.png}{0.15}{Keluaran Ketiga Program Bagi THR}{fig:m2:i3}
    ...
    \inputfigure{res/m2i4.png}{0.2}{Keluaran Pertama Program Motif Baju}{fig:m2:i4}
    ...
    \inputfigure{res/m2i5.png}{0.2}{Keluaran Kedua Program Motif Baju}{fig:m2:i5}
    ...
    \inputfigure{res/m2i6.png}{0.26}{Keluaran Ketiga Program Motif Baju}{fig:m2:i6}
